import {updateMintholderButton, updateMintpresaleButton, updateMintButton, updateMintByTierButtons} from "./ui.js";
...
export const init = async () => {
    ...
    await setContracts();
    updateConnectButton();
    updateMintholderButton();
    updateMintpresaleButton();
    updateMintButton();	
